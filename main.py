...
# Config 
class Config(object):
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "6774050110:AAHKJn6RO0oG25zzWaGHz7IKbHZs85ikVN8")
    API_ID = int(os.environ.get("API_ID", "27952989"))
    API_HASH = os.environ.get("API_HASH", "74f04808a359e9a516e955ec243613ca")
    DOWNLOAD_LOCATION = "./DOWNLOADS"
    SESSIONS = "./SESSIONS"

    AUTH_USERS = os.environ.get('AUTH_USERS', '5128979564,5186250641').split(',')
